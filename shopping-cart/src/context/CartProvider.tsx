...
const reducer = (state: CartStateType, action: ReducerAction): CartStateType => {
   switch (action.type) {
       case REDUCER_ACTION_TYPE.ADD: {
        ...
        const itemExitsts: CartItemType | undefined = state.cart.find(item => item.sku === sku)
        const qty: number = itemExitsts ? itemExitsts.qty + 1 : 1;
       ...
       case REDUCER_ACTION_TYPE.QUANTITY: {
        ...
        const updatedItem: CartItemType = { ...itemExitsts, qty }  
